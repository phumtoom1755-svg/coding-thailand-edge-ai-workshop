...
ไม่ต้องต่อเน็ต"
```
ช่วยsafeพนักงานที่ทำงานนานเกินไปให้รู้จักการดูเเลสุขภาพของตนเอง ต่างจากอย่างอื่นตรงที่บางทีเราต้องไปหาหมอด้วยตนเองเเเต่ของเราใช้เป็นเเอพให้เข้าถึงได้ง่าย
---
...
- จะ improve จาก V2 ตอนนี้อย่างไร?
  ...
  [เขียน]
  ```
จะปรับเเอพให้เสถียรยิ่งขึ้น
### c) Form Factor
- จะติดที่ไหน? ใช้ยังไง?
  ```
  [เขียน — เสริมด้วย sketch ถ้ามี]
  ```
ใช้กลับกล้องเล็กติดหน้าคอม
---
...
- [ ] ✅ Functionality: ตรวจจับท่าทางการนั่ง
- [ ] ✅ Accuracy: 50% ขึ้นไป
...
|---|---|---|
| | Hacker | Code integration |
| | Hipster | Ai train + design case |
| | Hustler | Documentation + Pitch deck + Idea |
